...
int main( int argc, const char **argv )
{
    ...
    std::cout << "12. MH2-Hash Function Value:   " << cocoa::MH2( key )   << std::endl;
    std::cout << "13. BJ1-Hash Function Value:   " << cocoa::BJ1( key )   << std::endl;
    std::cout << "14. CRC-Hash Function Value:   " << cocoa::GCRC( key )  << std::endl;
    std::cout << "15. SHA1-Hash Function Value:  " << cocoa::SHA1( key )  << std::endl;
